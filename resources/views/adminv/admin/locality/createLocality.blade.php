                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <form action="{{ route('admin.locality.store') }}" method="POST" class="row g-3 needs-validation"
                                      novalidate>
                                    @csrf
                                    <div class="col-md-6">
                                        <label for="parent_id" class="form-label">City*</label>
                                        <select class="form-select  @error('parent_id') is-invalid @enderror" name="parent_id" aria-label="parent_id">
