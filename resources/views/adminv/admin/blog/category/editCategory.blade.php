                            ...
                            <div class="p-4 border rounded">
                                <form action="{{ route('admin.blog-category.update',$category->id) }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" onblur='pk_slug_url(this.value,"pk-slug")' name="category_name" value="{{ $category->category_name }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="text" name="category_slug"
                                                   class="form-control  @error('category_slug') is-invalid @enderror" id="pk-slug" value="{{$category->category_slug}}"
                                                   required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select  @error('meta_robots') is-invalid @enderror"
                                            ...
                                            <option value="INDEX, FOLLOW" {{$category->meta_robots=="INDEX, FOLLOW" ? 'selected':''}} >INDEX, FOLLOW</option>
                                            <option value="NOINDEX, FOLLOW" {{$category->meta_robots=="NOINDEX, FOLLOW" ? 'selected':''}}>NOINDEX, FOLLOW</option>
                                            <option value="INDEX, NOFOLLOW" {{$category->meta_robots=="INDEX, NOFOLLOW" ? 'selected':''}}>INDEX, NOFOLLOW</option>
                                            <option value="NOINDEX, NOFOLLOW" {{$category->meta_robots=="NOINDEX, NOFOLLOW" ? 'selected':''}}>NOINDEX, NOFOLLOW</option>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <textarea rows="3" name="meta_keyword"
                                                      ...
                                                      id="terms_conditions"
                                                      required>{{ $category->meta_keyword }}</textarea>
