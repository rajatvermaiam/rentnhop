        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Create Blog Post</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <form action="{{ route('admin.blog-posts.store') }}" method="POST"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" onblur='pk_slug_url(this.value,"pk-slug")' name="post_title" value="{{ old('post_title') }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="text" name="post_slug"
                                                   class="form-control  @error('post_slug') is-invalid @enderror" id="pk-slug"
                                                   required>
